...
<body>
    ...
    <div class="container">
        ...
        <h1 class="display-4 text-center mb-5">Place Your Order Now</h1>
        ...
        <div class="card order-card mt-2 mb-3">
            ...
            <div class="card-body text-center">
                <hr>
                <button class="btn btn-primary" onclick="window.location='{{ route('orderCustomer') }}'">
        ...
        <div class="container">
            ...
            <div class="container">
                <div class="text-center mt-5">
                    <button class="btn btn-primary" onclick="window.location='{{ route('customerFeedback') }}'">
