        ...
        <div class="container mt-5">
            <div class="card">
                <div class="card-body">
                    <div class="card-body">
                        <div class="card">
                            <form action="{{ route('updateCategory', ['id' => $categories->id]) }}" method="post">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="price" id="price" class="form-control" required="required" value="{{ $categories->price }}" placeholder="Enter price from this category">
                                </div>
